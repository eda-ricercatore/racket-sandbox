...
#|
Source code is at: https://onecompiler.com/racket/3x3vnwrsp
...
(print "Hello, World!")
(println "Ciao Mondo, using println!!!")
(writeln "Ciao Mondo, using writeln!!!")
...
(while (string=? "June 30" "June 30")
  (println "Happy Birthday, Dr. BLAH!")
  (println "...!")) ; else, do nothing.
#|
;; fun-while : (-> Boolean) (-> Any) -> Void
(define (fun-while condition body)
  (when (let ((currentDay (date->string (current-date) "~B ~e")) (birthday "June 43"))
    (string=? birthday currentDay))
    (println "Happy Birthday, Dr. BLAH!")
    (fun-while condition body))
|#
